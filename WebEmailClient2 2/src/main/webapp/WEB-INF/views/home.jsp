...
<body>
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary "
							data-dismiss="modal" onclick='sendMessage();'>
	...
	<div class="jumbotron">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="well">
					<centre>
					<strong> Status: " yayy! my emailsystem is working *happy*
						" </strong></centre>
				</div>
			</div>
			<div class="col-md-2">
	...
	<div class="container">
		<div class="row">
			<button class="glyphicon glyphicon-repeat" type="button">Refresh</button>
		</div>
		<div class="row">

			<div class="col-md-10" id="mainpage"></div>
			...
			<div class="col-md-2">
				...
				<div id="sidebar-wrapper">
					<ul class="sidebar-nav">
						...
						<li class="sidebar-brand"><a href="#" data-toggle="modal"
							data-target="#myModal">COMPOSE </a></li>
						<li><a href="#" onclick='MakeRequest();'>INBOX</a></li>
						<li><a href="#" onclick='doOutbox();'>SENT</a></li>
						<li><a href="#" onclick='doDrafts();'>DRAFTS</a></li>
						<li><a href="#" onclick='doTrash();'>TRASH</a></li>
						<li><a href="#" onclick='doSpam()'>SPAM</a></li>
						<li><a href="#" onclick='doStarred();'>STARRED</a></li>
						<li><a href="#" onclick='doContacts();'>CONTACTS</a></li>
					</ul>
				</div>
			</div>
